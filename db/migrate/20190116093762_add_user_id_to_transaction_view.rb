class AddUserIdToTransactionView < ActiveRecord::Migration[5.1]
  def up
    ...
    sql_command = %{
	    CREATE VIEW transaction_view AS
		    SELECT usr.id AS user_id, tup.id AS topup_id, tup.amount AS topup_amount, tup.method, tup.result, wd.id AS withdraw_id, wd.account_to, wd.amount AS withdraw_amount,
